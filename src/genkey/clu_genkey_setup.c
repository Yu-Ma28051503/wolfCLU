...
int wolfCLU_genKeySetup(int argc, char** argv)
{
    ...
    if (0) {
        ...
        if (ret > 0 && argv[ret+1] != NULL) {
            ...
            switch (levelArg) {
                ...
                case 5:
                    ...
                    break;
                default:
                    WOLFCLU_LOG(WOLFCLU_L0, "Invalid -level (%s), using level%d", argv[ret+1], levelArg);
                    break;
            }
        }
        else {
            ...
            WOLFCLU_LOG(WOLFCLU_L0, "DEFAULT: use Level %d", levelArg);
        }
        ...
        WOLFCLU_LOG(WOLFCLU_L0, "using Dilithium%d", levelArg);
        ret = wolfCLU_genKey_Dilithium(&rng, keyOutFName, directiveArg, formatArg, keySz, levelArg, withAlg);
